...
class main_window():
    ...
    def initialize_dropdown_id(self):

        self.dropdown_id_options = []

        self.dropdown_id = ttk.Combobox(self.root, values=self.dropdown_id_options, state='readonly', font=("Consolas", 16))

        self.dropdown_id.place(x=self.screen_width * 0.40, y=self.screen_height * 0.815 + 2, width= self.screen_width * 0.02, anchor=tkinter.W)

        self.dropdown_id.set(1)
    ...
    def initialize_button_add_left(self):
        ...
        self.button_add_vehicle.bind('<ButtonRelease-1>', self.button_add_release)
    ...
    def initialize_vehicles(self):
        ...
        for rows in vehicles:
            ...
            self.dropdown_id_options.append(id)
        
        self.dropdown_id.configure(values=self.dropdown_id_options)
    ...
    def initialize_trips(self, event, vehicle_id):
        ...
        for rows in trips:
            ...
            line1 = f"{str(driver_name):<{15}}{str(date):<{15}}{str(purpose):<{20}}{str(location_start):<{10}}{str(location_end):<{10}}"
            line2 = f"{str(time_start):<{15}}{str(time_end):<{15}}{str(date):<{20}}{str(km_before):<{10}}{str(km_after):<{10}}{str(distance):<{10}}"
    ...
    def initialize_entry_right(self):
        ...
        self.entry_texts_right = {
            ...
            'km_before' :      None,
            'km_after' :       'Stav tachometra po jazde',
            'distance' :       None
        }

        self.entry_names_right = ['driver_name', 'purpose','location_start', 'location_end', 'date', 'km_after', 'time_start', 'time_end']
        #vehicle_id
    ...
    def initialize_button_add_right(self):
        ...
        self.button_add_trip.place(
            ...
            width=int(self.screen_width * 0.05 - 2), 
            height=int(self.screen_height*0.05) - 2)
        self.button_add_trip.bind('<ButtonRelease-1>', self.button_add_release)



    def button_add_release(self, event):
        ...
        if event.widget == self.button_add_vehicle:                                         # add vehicle button (left)
            ...
            self.entry_add_right['vehicle_id'] = self.dropdown_id.get()
